...
final class StoreMateriRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'file' => [
                Rule::when(
                    condition: $this->isFileBasedType(),
                    rules: [
                        'required',
                        'file',
    ...
    public function messages(): array
    {
        return [
            ...
            'file.required' => 'File wajib diunggah untuk tipe PDF atau Image.',
    ...
    public function toCreateData(int $createdBy): MateriCreateData
    {
        return new MateriCreateData(
